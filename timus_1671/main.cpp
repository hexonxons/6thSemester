...
int main(int argc, char **argv)
{
	...
	// проходим по всему стеку и ищем количество компонент
	for(i = 0; i < numOfEdges; ++i)
	{
	...
	// уииии!
	// теперь надо бы посчитать реальное количество кластеров
	// не все вершины могли попасть в кластеры
