...
{
    // TODO - Задать вопрос о целесообразности очистки
...
void CSortDlg::OnAdd() 
{
    ...
    CString Date = m_Date.Format("%d.%m.%Y");
    ...
    // TODO - вставить данные в вектор для сортировки и в список отображения
	m_Array.Add(pNew);
...
void CSortDlg::OnSort() 
{
    ...
    //TODO - вставить выдачу сортированного массива в результирующий список
   // ASSERT(0);
}
...
void Sort(Sort1Array &array)
{
	std::sort(array.GetData(), array.GetData()+array.GetSize(), CompareByDate);
